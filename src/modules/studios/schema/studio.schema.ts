...
export const updateStudioProfileSchema = z.object({
  ...
  showStorefrontBanner: z.boolean().nullish(),
  storefrontBannerUrl: z.string().nullish(),
  storefrontBannerHeader: z.string().max(100).nullish(),
  storefrontBannerBody: z.string().max(300).nullish(),
  storefrontBannerTextColor: z.string().nullish(),
  storefrontBannerBgColor: z.string().nullish(),
  showStorefrontSales: z.boolean().nullish(),
  storefrontSalesPosition: z.enum(["top", "bottom"]).nullish(),
  storefrontSalesUrl: z.string().nullish(),
  storefrontSalesHeader: z.string().max(100).nullish(),
  storefrontSalesBody: z.string().max(300).nullish(),
  storefrontSalesBtnText: z.string().max(50).nullish(),
  storefrontSalesBtnUrl: z.string().nullish(),
  storefrontSalesLinkType: z.string().nullish(),
