...
export async function getStorefrontBySlug(
  ...
  const result: StudioStorefrontResponseDto = {
    ...
    showStorefrontBanner: business.showStorefrontBanner ?? true,
    storefrontBannerUrl: business.storefrontBannerUrl,
    storefrontBannerHeader: business.storefrontBannerHeader,
    storefrontBannerBody: business.storefrontBannerBody,
    storefrontBannerTextColor: business.storefrontBannerTextColor,
    storefrontBannerBgColor: business.storefrontBannerBgColor,
    showStorefrontSales: business.showStorefrontSales ?? false,
    storefrontSalesPosition: business.storefrontSalesPosition ?? "bottom",
    storefrontSalesUrl: business.storefrontSalesUrl,
    storefrontSalesHeader: business.storefrontSalesHeader,
    storefrontSalesBody: business.storefrontSalesBody,
    storefrontSalesBtnText: business.storefrontSalesBtnText,
    storefrontSalesBtnUrl: business.storefrontSalesBtnUrl,
    storefrontSalesLinkType: business.storefrontSalesLinkType,
